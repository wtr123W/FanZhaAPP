    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ("".equals(room)) {//学院不能为空
                    Toast.makeText(RegisterActivity.this, "学院不能为空", Toast.LENGTH_LONG).show();
                    return;
                }
                ...
                if (mUser == null) {//用户不存在 注册
                    ...
                    db.execSQL(insertSql, new Object[]{account, password, nickName, sex, phone, room, imagePath, 0});
